...
<body>
    ...
    <div>
        <!-- HEADER -->
        <header class="bg-white w-full py-[1.5em] px-[2em]">
            <!-- Container do HEADER -->
            <div class="container flex justify-between items-center">
                ...
                <!-- BOTÕES -->
                <div>
                    <a class="text-header">Carreiras</a>
                    <a>Login</a>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="container flex flex-row justify-between items-center px-[8em]">
        ...
        <script>
            function scrollCarousel(carouselId, direction) {
                ...
                const scrollAmount = 640 + 48; // 344px total
                carousel.scrollBy({
